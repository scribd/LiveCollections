//
//  ScenarioFiveViewController.swift
...
final class ScenarioFiveViewController: UIViewController {
    ...
    private lazy var collectionData: CollectionSectionData<MovieSection> = {
        return CollectionSectionData<MovieSection>(view: collectionView)
    }()
...
extension ScenarioFiveViewController: UICollectionViewDataSource {
...
extension ScenarioFiveViewController: UICollectionViewDelegate {
...
extension ScenarioFiveViewController: MultiSectionDataCoordinatorDelegate {
